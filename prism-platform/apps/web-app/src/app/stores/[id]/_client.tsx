...
// ÔöÇÔöÇ Status color configs ÔöÇÔöÇ
...
// ÔöÇÔöÇ Loading skeleton ÔöÇÔöÇ
...
export default function StoreIntelligencePage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="space-y-8 animate-fadeInUp">
      ...
      {/* ÔöÇÔöÇ Time Range + Trend Chart ÔöÇÔöÇ */}
      ...
      {/* ÔöÇÔöÇ Score Breakdown + Program Performance ÔöÇÔöÇ */}
      ...
      {/* ÔöÇÔöÇ Recent Submissions ÔöÇÔöÇ */}
      ...
      {/* ÔöÇÔöÇ Open Tasks + Recurring Issues ÔöÇÔöÇ */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Open Tasks */}
              ...
              return (
                <div key={issue.id} className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/[0.02] border border-white/[0.03]">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-obsidian-400 mt-0.5">{issue.category} ┬À {issue.frequency} occurrences</div>
                  </div>
      ...
      {/* ÔöÇÔöÇ Evidence Gallery ÔöÇÔöÇ */}
      <div className="widget p-6 animate-fadeInUp">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                  <div className="absolute bottom-0 left-0 right-0 p-2">
                    ...
                    <div className="text-[9px] text-white/60 truncate">{item.programName} ┬À {item.uploadedBy}</div>
                  </div>
                </div>
              </button>
            ))}
      ...
      {/* ÔöÇÔöÇ Lightbox Overlay ÔöÇÔöÇ */}
      {lightboxUrl && (
        <div
